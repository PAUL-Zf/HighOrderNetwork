...
export default {
    ...
    methods: {
        ...
        alternativeDesgin: function (){
            // pattern alternative desgin
            const svg = d3.select("#sankey")
            .append('svg')
            .attr("class", "state")
            .attr("width", 600)
            ...
            let triangle = d3.symbol().type(d3.symbolTriangle).size(200)
            ...
            //     .attr("fill", 'none')
            //     .attr('d', lineGenerator.curve(d3['curveBasis'])([[100, 100], [180, 40], [300, 100]]))
            ...
            //     .attr("stroke-width", 13)
            //     .attr("fill", 'none')
            //     .attr('d', lineGenerator.curve(d3['curveBasis'])([[300, 100], [380, 40], [500, 100]]))
            ...
            //     .attr("stroke-width", 13)
            //     .attr("fill", 'none')
            //     .attr('d', lineGenerator.curve(d3['curveBasis'])([[100, 100], [260, 40], [500, 100]]))
            ...
            //     .attr("stroke-width", 13)
            //     .attr("fill", 'none')
            //     .attr('d', lineGenerator.curve(d3['curveBasis'])([[300, 100], [420, 160], [500, 100]]))
            ...
            //     .attr("stroke-width", 13)
            //     .attr("fill", 'none')
            //     .attr('d', lineGenerator.curve(d3['curveBasis'])([[500, 100], [420, 160], [300, 100]]))
            ...
            //     .attr("stroke-width", 13)
            //     .attr("fill", 'none')
            //     .attr('d', lineGenerator.curve(d3['curveBasis'])([[300, 100], [220, 160], [100, 100]]))
            ...
            //     .attr("stroke-width", 13)
            //     .attr("fill", 'none')
            //     .attr('d', lineGenerator.curve(d3['curveBasis'])([[100, 100], [180, 10], [500, 100]]))
            ...
            //     .attr("stroke-width", 13)
            //     .attr("fill", 'none')
            //     .attr('d', lineGenerator.curve(d3['curveBasis'])([[100, 100], [150, 10], [300, 100]]))
            ...
            //     .attr("stroke-width", 13)
            //     .attr("fill", 'none')
            //     .attr('d', lineGenerator.curve(d3['curveBasis'])([[300, 100], [250, 190], [100, 100]]))
            // svg.append('path')
            //     .attr("stroke", 'lightsteelblue')
            //     .attr("stroke-width", 10)
            //     .attr("fill", 'none')
            ...
            //     .attr("stroke-width", 10)
            //     .attr("fill", 'none')
            //     .attr('d', lineGenerator.curve(d3['curveBasis'])([[100, 100], [300, 100]]))

            // svg.append('path')
            //     .attr("stroke", 'lightsteelblue')
            //     .attr("stroke-width", 10)
            //     .attr("fill", 'none')
            //     .attr('d', lineGenerator.curve(d3['curveBasis'])([[300, 100], [500, 100]]))

            // svg.append('path')
            //     .attr("d", triangle)
            //     .attr("fill", 'lightsteelblue')
            //     .attr("transform", "translate(233.4, 100) rotate(90)")

            // svg.append('path')
            //     .attr("d", triangle)
            //     .attr("fill", 'lightsteelblue')
            //     .attr("transform", "translate(433.4, 100) rotate(90)")
            ...
            //     .attr("d", triangle)
            //     .attr("fill", 'lightsteelblue')
            //     .attr("transform", "translate(166.6, 100) rotate(-90)")
