import { polyline, polygon, Layer, Polyline, latLngBounds, Circle, GeoJSON, CircleMarker, Marker, point, MarkerCluster, Util, Path, Handler, DomUtil, DomEvent, Control } from 'leaflet';
...
var LassoHandler = /** @class */ (function (_super) {
    ...
    LassoHandler.prototype.finish = function () {
        ...
        this.map.eachLayer(function (layer) {
            ...
            if (MarkerCluster && layer instanceof MarkerCluster) {
                layers.push.apply(layers, layer.getAllChildMarkers());
            }
            else if (layer instanceof Marker || layer instanceof Path) {
                layers.push(layer);
            }
        });
